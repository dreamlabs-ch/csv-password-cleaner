          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
            ...
            >
              <motion.h1 
                ...
                className="text-4xl font-bold tracking-tight sm:text-5xl lg:text-6xl bg-clip-text text-transparent bg-gradient-to-r from-white to-blue-100"
              >
          ...
          {!passwordGroups.length && !isLoading && (
            ...
            >
              ...
              <motion.div 
                ...
                className="grid grid-cols-1 gap-8 sm:grid-cols-3 mt-8"
              >
                {[
                  {
              ...
              <motion.section 
                ...
                className="mt-24 bg-white rounded-3xl overflow-hidden shadow-xl border border-gray-100"
              >
